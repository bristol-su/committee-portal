...
//
//    /** @test */
//    public function it_returns_null_if_the_activity_admin_logic_is_not_found(){
//        $user = factory(User::class)->create();
...
//
//    /** @test */
//    public function it_returns_null_if_the_activity_for_logic_is_not_found(){
//        $user = factory(User::class)->create();
//        $activity = factory(Activity::class)->create([
//            'for_logic' => 100
//        ]);
...
//
//    /** @test */
//    public function it_returns_true_if_the_admin_is_in_the_activity_admin_logic(){
//        $logic = factory(Logic::class)->create();
//        $user = factory(User::class)->create();
//        $logicTester = $this->prophesize(LogicTester::class);
//        $logicTester->evaluate(Argument::that(function($logicArgument) use ($logic) {
...
//
//    /** @test */
//    public function it_returns_true_if_the_participant_is_in_the_activity_for_logic(){
//        $logic = factory(Logic::class)->create();
//        $user = factory(User::class)->create();
//        $logicTester = $this->prophesize(LogicTester::class);
//        $logicTester->evaluate(Argument::that(function($logicArgument) use ($logic) {
...
//
//    /** @test */
//    public function it_returns_false_if_the_admin_is_in_the_activity_admin_logic(){
//        $logic = factory(Logic::class)->create();
//        $user = factory(User::class)->create();
//        $logicTester = $this->prophesize(LogicTester::class);
//        $logicTester->evaluate(Argument::that(function($logicArgument) use ($logic) {
...
//
//    /** @test */
//    public function it_returns_false_if_the_participant_is_in_the_activity_for_logic(){
//        $logic = factory(Logic::class)->create();
//        $user = factory(User::class)->create();
//        $logicTester = $this->prophesize(LogicTester::class);
//        $logicTester->evaluate(Argument::that(function($logicArgument) use ($logic) {
