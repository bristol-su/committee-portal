        ...
        <div v-else>
                ...
                <b-col>
                    <b-table striped hover :items="modules" :fields="moduleFields">
                        <template slot="view" slot-scope="data">
                            <a :href="'/settings/activity/' + activity.id + '/module_instance/' + data.item.id"><b-button variant="primary">View</b-button></a>
                        </template>
                    </b-table>
                </b-col>
            </b-row>
            <b-row>
                <b-col style="text-align: right; padding-right: 10px;">
                    <a :href="'/settings/activity/' + activity.id + '/module_instance/create'">
