<template>
    <div>
        ...
        <div v-else>
            ...
            <div class="detailBox">
                <div class="titleBox">
                    <label>Notes on '{{document.title}}'</label>
...
<script>
    ...
    export default {
        ...
        methods: {
            postNote() {
                this.$http.post('/admin/exitingtreasurer/post-note/' + this.document.id, {
                    note: this.note
                })
                    .then(response => {
                        this.$emit('updateddocument', response.data);
                        this.note = '';
                    })
                    .catch(error => {
        ...
        computed: {
            sortedNotes() {
                return this.document.notes.sort(function (a, b) {
        ...
        created() {
            this.$http.get('/admin/exitingtreasurer/retrieve-note-templates')
