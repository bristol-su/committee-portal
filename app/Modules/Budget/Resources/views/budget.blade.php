            ...
            <div class="row">
                <div class="col-md-12" style="text-align: left;">
                    <p>A budget is an estimate of your income and expenditure for a set period, prepared in advance. A
                        ...
                        resources to carry out your planned activities. During the year you should monitor your
                        performance against your budget so that you can take corrective action if things do not go to
                        plan.</p>

                    <p>We've made a <a href="{{serveStatic('bristol-su-group-budget-template.xls')}}">template</a> to help
                        you create your budget.</p>

                    <p>If this section is optional for your group, we would still recommend that you prepare a budget,
                        but its not essential for your reaffiliation.</p>
                </div>
            </div>
