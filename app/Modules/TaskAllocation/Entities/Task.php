...
class Task extends Model
{
    ...
    protected $table = 'taskallocation_tasks';
    ...
    public function tag()
    {
        $studentTag = StudentTag::all()->filter(function (StudentTag $studentTag) {
            ...
            return
                ...
                $studentTag->category->reference === 'task_allocations';
        });

        if ($studentTag === false) {
            throw new \Exception('Could not find a tag: task_allocations.' . $this->tagReference, 500);
        }
